...
void mule::Data::Basic::Double::Read(xybase::Stream *stream, DataHandler *dataHandler) const
{
	dataHandler->OnDataRead(stream->ReadDouble());
}

void mule::Data::Basic::Double::Write(xybase::Stream *stream, DataHandler *dataHandler) const
{
