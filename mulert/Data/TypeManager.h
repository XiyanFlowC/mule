	...
	namespace Data
	{
		...
		*/
		...
		public:
			...
			*/
			MULERT_API static TypeManager &GetInstance();
			...
			*/
			MULERT_API void RegisterObject(Basic::Type *object, std::u16string name);

			/**
			 * @brief Unregister the object specified by its name.
			 * @param name The name of the object need to be unregistered.
			*/
			MULERT_API void UnregisterObject(std::u16string name);
			...
			*/
			MULERT_API void ReleaseObject(std::u16string name);
			...
			*/
			MULERT_API void RegisterObjectCreator(TypeCreator *creator);
			...
			*/
			MULERT_API Basic::Type *GetOrCreateType(std::u16string name);
			...
			*/
			MULERT_API Basic::Type *GetOrCreateType(std::u16string name, const std::map<std::u16string, std::u16string> &metainfo);
			 ...
			 * @return
			*/
			MULERT_API Basic::Type *GetType(std::u16string name);
		protected:
